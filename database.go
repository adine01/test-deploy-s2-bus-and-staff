...
func InitDB() error {
	...
	if databaseURL == "" {
		log.Printf("DATABASE_URL environment variable not found, this is required for database connection")
		log.Printf("Please set DATABASE_URL in your deployment environment")
